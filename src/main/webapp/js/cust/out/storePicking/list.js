...
$().ready(function() {
	$("#totalPickingApplicationSmModal").on("hidden.bs.modal", function() {
		$(this).removeData("bs.modal");
	});
	$("#totalPickingApplicationModal").on("hidden.bs.modal", function() {
	...
	totalPickingApplicationTable.bootstrapTable({
		...
		onDblClickRow: function(row) {
			//双击加载明细
//			showTotalPickingModal('../out/total-picking!detail.html?storePickingSearch.orderIds=' + row.orderId);
		}
	});
...
function printTotalPicking() {
	...
	//双击加载明细
	showTotalPickingModal('../out/store-picking!detail.html?storePickingSearch.orderIds=' + ids);
}
