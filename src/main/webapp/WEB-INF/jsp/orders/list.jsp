...
<%--输入单号--%>
<div class="modal inmodal fade" id="inputOrder" tabindex="-1" role="dialog"  aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title">已发货</h4>
      </div>
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <form class="form-inline">
              <div class="form-group col-sm-12 " style="padding-bottom: 10px;">
                ...
                <div class="col-sm-8">
                  ...
                  <%--<input  type="text" name="express" id="express" class="form-control" placeholder="请输入快递公司名称" value="">--%>
                </div>
              </div>
              <div class="form-group col-sm-12 " style="padding-bottom: 10px;">
                <label class="col-sm-3 control-label">快递单号：</label>
                <div class="col-sm-8">
                  <input  type="text" name="expressNo" id="expressNo" class="form-control" placeholder="请输入快递单号" value="">
                </div>
              </div>
            </form>
          </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-white btn-sm" data-dismiss="modal">关闭</button>
        <button type="button" id="sendOrder" class="btn btn-primary btn-sm">保存</button>
      </div>
    </div>
  </div>
</div>
...
<script src="${ctx}/js/orders/list.js"></script>
</body>
</html>