...
<head>
	...
	<script src="${ctx}/js/cust/move/inOutPositionDetail.js"></script>
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                	 <div id="toolBar">
						<button id="reprotInOutPosition" type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-export"></span>&nbsp;导出</button>
<!-- 	                        <button id="inOutDetailExportBtn" class="btn btn-success btn-sm" type="button">  -->
<!-- 	                          <i class="glyphicon glyphicon-export"></i> 导出 -->
<!-- 	                         </button> -->
	                  </div>
                    <table id="inOutPositionDetail" class="text-nowrap"  data-mobile-responsive="true"></table>
                </div>
            </div>
        </div>
    </div>
