...
<head>
	...
	<script src="${ctx}/js/cust/in/application/input.js"></script>
</head>
<body class="gray-bg">
	  ...
	  <div class="modal-body">
	     <form role="form" class="form-horizontal">
           <div id="toolBar" style="padding-bottom: 1px;">
				<button id="inApplicationAddLine" type="button" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-plus"></span>&nbsp;添加</button>
				<button id="inApplicationDelLine" type="button" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span>&nbsp;删除</button>
	       </div>
