          ...
          <div class="col-md-12">
            <form class="form-inline">
              <div class="form-group col-sm-12 " style="padding-bottom: 10px;">
                ...
                <div class="col-sm-8">
                  <input  type="text" name="platformName" class="form-control" placeholder="" id="platformName">
                </div>
              </div>
              <div class="form-group col-sm-12 " style="padding-bottom: 10px;">
                <label class="col-sm-3 control-label">平台所有人：</label>
                <div class="col-sm-8">
                  <input  type="text" name="platformOwner" class="form-control" placeholder="" id="platformOwner">
                </div>
              </div>
              <div class="form-group col-sm-12 " style="padding-bottom: 10px;">
                <label class="col-sm-3 control-label">HNB数量：</label>
                <div class="col-sm-8">
                  <input  type="text" name="coin" class="form-control" placeholder="" id="coin">
                </div>
              </div>
              <div class="form-group col-sm-12 " style="padding-bottom: 10px;">
                <label class="col-sm-3 control-label">可提HNB数量：</label>
                <div class="col-sm-8">
                  <input  type="text" name="withdrawCoin" class="form-control" placeholder="" id="withdrawCoin">
                </div>
              </div>
              ...
              <div class="form-group col-sm-12 " style="padding-bottom: 10px;">
                ...
                <div class="col-sm-8">
                  <input  type="text" name="password" class="form-control" placeholder="" id="password">
                </div>
              </div>
            </form>
          </div>
...
<div class="modal inmodal fade" id="UpdateModal" tabindex="-1" role="dialog"  aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
          ...
          <div class="col-md-12">
            <form class="form-inline">
              <div class="form-group col-sm-12 " style="padding-bottom: 10px;">
                <label class="col-sm-3 control-label">平台名称：</label>
                <div class="col-sm-8">
                  <input  type="text" name="platformName" class="form-control" placeholder="" id="uplatformName">
                </div>
              </div>
              <div class="form-group col-sm-12 " style="padding-bottom: 10px;">
                <label class="col-sm-3 control-label">平台所有人：</label>
                <div class="col-sm-8">
                  <input  type="text" name="platformOwner" class="form-control" placeholder="" id="uplatformOwner">
                </div>
              </div>
              <div class="form-group col-sm-12 " style="padding-bottom: 10px;">
                <label class="col-sm-3 control-label">HNB数量：</label>
                <div class="col-sm-8">
                  <input  type="text" name="coin" class="form-control" placeholder="" id="ucoin">
                </div>
              </div>
              <div class="form-group col-sm-12 " style="padding-bottom: 10px;">
                <label class="col-sm-3 control-label">可提HNB数量：</label>
                <div class="col-sm-8">
                  <input  type="text" name="withdrawCoin" class="form-control" placeholder="" id="uwithdrawCoin">
                </div>
              </div>
              ...
              <div class="form-group col-sm-12 " style="padding-bottom: 10px;">
                <label class="col-sm-3 control-label">用户名：</label>
                <div class="col-sm-8">
                  <input  type="text" name="username" class="form-control" placeholder="" id="uusername">
                </div>
              </div>
              <div class="form-group col-sm-12 " style="padding-bottom: 10px;">
                <label class="col-sm-3 control-label">密码：</label>
                <div class="col-sm-8">
                  <input  type="text" name="password" class="form-control" placeholder="" id="upassword">
                </div>
              </div>
            </form>
          </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-white btn-sm" data-dismiss="modal">关闭</button>
        <button type="button" id="update" class="btn btn-primary btn-sm">保存</button>
      </div>
    </div>
  </div>
</div>
...
<script src="${ctx}/js/platform/list.js"></script>
