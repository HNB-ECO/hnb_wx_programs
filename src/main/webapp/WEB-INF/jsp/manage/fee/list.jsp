...
<head>
    ...
    <script src="${ctx}/js/cust/manage/fee.js?v=1"></script>
	...
	<script type="text/javascript">
		var feeTypeJson = 'json:${feeTypeJson}';
		var feeUnitJson = 'json:${feeUnitJson}';
		var warehouseJson = 'json:${warehouseJson}';
	</script>
</head>
<body class="gray-bg">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <div id="toolBar">
                    	<button id="reprotFee" type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-export"></span>&nbsp;导出</button>
