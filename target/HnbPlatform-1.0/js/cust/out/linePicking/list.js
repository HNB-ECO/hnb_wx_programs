...
$().ready(function() {
	...
	totalPickingApplicationTable.bootstrapTable({
		...
		onDblClickRow: function(row) {
			//双击加载明细
//			showTotalPickingModal('../out/line-picking!detail.html?storePickingSearch.orderIds=' + row.orderId);
		}
	});
...
function printTotalPicking() {
	...
	//双击加载明细
	showTotalPickingModal('../out/line-picking!detail.html?storePickingSearch.orderIds=' + ids);
//	// 显示模态框
