...
$().ready(function(){
    ...
    window.operateEvents = {
        'click .RoleOfedit': function (e, value, row, index) {
            alertConfirm(function(){
                $.ajax({
                    url: "/admin/withdraw/completeWithdraw",
                    type: "post",
                    data: {
                        withdrawChargeId:value,
                        withdrawResult:'0'
                    },
                    cache: false,
                    beforeSend: function() {
    ...
    $table.bootstrapTable({
        url: "/admin/withdraw/getWithdrawChargeList",//加载数据的url
        // uniqueId: "goodNameId",
        ...
        columns: [
            ...
            },
            {
                ...
                formatter:  function operateFormatter(value, row, index) {
                    return [
                        '<input type="submit" value="成功" class="RoleOfedit btn btn-primary  btn-sm"   style="display: inline-block" data-toggle="modal"  style="display:inline-block" >',
                        '<input type="submit" value="失败" class="FailOfedit btn btn-danger btn-sm"  style="display: inline-block"  data-toggle="modal"  style="display:inline-block" >',
                    ].join('');
                }
            }
